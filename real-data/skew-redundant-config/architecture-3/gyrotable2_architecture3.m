...
[mov1.nav3, mov1.kf.nav3] = arch3_imu2cm_filter_nomag(mov1.imu3);
[mov1.nav4, mov1.kf.nav4] = arch3_imu2cm_filter_nomag(mov1.imu4);

[mov1.navCM] = attitude_average_arch3(mov1.nav1, mov1.nav2, mov1.nav3, mov1.nav4);
...
[mov2.nav3, mov2.kf.nav3] = arch3_imu2cm_filter_nomag(mov2.imu3);
[mov2.nav4, mov2.kf.nav4] = arch3_imu2cm_filter_nomag(mov2.imu4);

[mov2.navCM] = attitude_average_arch3(mov2.nav1, mov2.nav2, mov2.nav3, mov2.nav4);
...
[mov3.nav3, mov3.kf.nav3] = arch3_imu2cm_filter_nomag(mov3.imu3);
[mov3.nav4, mov3.kf.nav4] = arch3_imu2cm_filter_nomag(mov3.imu4);

[mov3.navCM] = attitude_average_arch3(mov3.nav1, mov3.nav2, mov3.nav3, mov3.nav4);
...
% Attitude EKF for each sensor
[mov4.nav1, mov4.kf.nav1] = arch3_imu2cm_filter_nomag(mov4.imu1);
[mov4.nav2, mov4.kf.nav2] = arch3_imu2cm_filter_nomag(mov4.imu2);
[mov4.nav3, mov4.kf.nav3] = arch3_imu2cm_filter_nomag(mov4.imu3);
[mov4.nav4, mov4.kf.nav4] = arch3_imu2cm_filter_nomag(mov4.imu4);

[mov4.navCM] = attitude_average_arch3(mov4.nav1, mov4.nav2, mov4.nav3, mov4.nav4);
arch3_mov4_navCM = mov4.navCM;

save('arch3_mov4_navCM','arch3_mov4_navCM');
...
sgtitle('quaternions - KF. Movement 4. Architecture 3.','interpreter','latex')

subplot(4,1,1)
plot(mov4.navCM.t, mov4.navCM.qua(:,1), 'go')
hold on
...
subplot(4,1,2)
plot(mov4.navCM.t, mov4.navCM.qua(:,2), 'go')
hold on
...
subplot(4,1,3)
plot(mov4.navCM.t, mov4.navCM.qua(:,3), 'go')
hold on
...
subplot(4,1,4)
plot(mov4.navCM.t, mov4.navCM.qua(:,4), 'go')
hold on
...
fh = figure(8);
sgtitle('Euler angles - KF. Movement 4. Architecture 3.','interpreter','latex')

subplot(3,1,1)
plot(mov4.navCM.t, mov4.navCM.roll, 'go')
hold on
...
subplot(3,1,2)
plot(mov4.navCM.t, mov4.navCM.pitch, 'go')
hold on
...
subplot(3,1,3)
plot(mov4.navCM.t, mov4.navCM.yaw, 'go')
hold on
...
% Attitude EKF for each sensor
[mov5.nav1, mov5.kf.nav1] = arch3_imu2cm_filter_nomag(mov5.imu1);
[mov5.nav2, mov5.kf.nav2] = arch3_imu2cm_filter_nomag(mov5.imu2);
[mov5.nav3, mov5.kf.nav3] = arch3_imu2cm_filter_nomag(mov5.imu3);
[mov5.nav4, mov5.kf.nav4] = arch3_imu2cm_filter_nomag(mov5.imu4);
...
[mov5.navCM] = attitude_average_arch3(mov5.nav1, mov5.nav2, mov5.nav3, mov5.nav4);


arch3_mov5_navCM = mov5.navCM;

save('arch3_mov5_navCM','arch3_mov5_navCM');
...
sgtitle('quaternions - KF. Movement 5. Architecture 3.','interpreter','latex')

subplot(4,1,1)
plot(mov5.navCM.t, mov5.navCM.qua(:,1), 'go')
hold on
...
subplot(4,1,2)
plot(mov5.navCM.t, mov5.navCM.qua(:,2), 'go')
hold on
...
subplot(4,1,3)
plot(mov5.navCM.t, mov5.navCM.qua(:,3), 'go')
hold on
...
subplot(4,1,4)
plot(mov5.navCM.t, mov5.navCM.qua(:,4), 'go')
hold on
...
fh = figure(10);
fh.WindowState = 'maximized';
sgtitle('Euler angles - KF. Movement 5. Architecture 3.','interpreter','latex')

subplot(3,1,1)
plot(mov5.navCM.t, mov5.navCM.roll, 'go')
hold on
...
subplot(3,1,2)
plot(mov5.navCM.t, mov5.navCM.pitch, 'go')
hold on
...
subplot(3,1,3)
plot(mov5.navCM.t, mov5.navCM.yaw, 'go')
hold on
