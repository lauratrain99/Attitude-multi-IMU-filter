...
[mov1.navCM, mov1.kf] = arch4_imu2cm_filter_nomag(mov1.imu1, mov1.imu2, mov1.imu3, mov1.imu4);

[mov1.navCM_datafusion] = attitude_average_arch4(mov1.navCM);
arch4_mov1_navCM = mov1.navCM_datafusion;
save('arch4_mov1_navCM','arch4_mov1_navCM');
...
sgtitle('quaternions - KF. Movement 1. Architecture 4.','interpreter','latex')

subplot(4,1,1)
plot(mov1.navCM_datafusion.t, mov1.navCM_datafusion.qua(:,1), 'mo')
hold on
plot(mov1.navCM_datafusion.t, mov1.quat(:,1), 'k','LineWidth',2)
hold off
...
subplot(4,1,2)
plot(mov1.navCM_datafusion.t, mov1.navCM_datafusion.qua(:,2), 'mo')
hold on
plot(mov1.navCM_datafusion.t, mov1.quat(:,2), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
...
subplot(4,1,3)
plot(mov1.navCM_datafusion.t, mov1.navCM_datafusion.qua(:,3), 'mo')
hold on
plot(mov1.navCM_datafusion.t, mov1.quat(:,3), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
...
subplot(4,1,4)
plot(mov1.navCM_datafusion.t, mov1.navCM_datafusion.qua(:,4), 'mo')
hold on
plot(mov1.navCM_datafusion.t, mov1.quat(:,4), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
...
fh = figure(2);
sgtitle('Euler angles - KF. Movement 1. Architecture 4.','interpreter','latex')

subplot(3,1,1)
plot(mov1.navCM_datafusion.t, mov1.navCM_datafusion.roll, 'mo')
hold on
plot(mov1.navCM_datafusion.t, rad2deg(mov1.roll_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
...
subplot(3,1,2)
plot(mov1.navCM_datafusion.t, mov1.navCM_datafusion.pitch, 'mo')
hold on
plot(mov1.navCM_datafusion.t, rad2deg(mov1.pitch_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
...
subplot(3,1,3)
plot(mov1.navCM_datafusion.t, mov1.navCM_datafusion.yaw, 'mo')
hold on
plot(mov1.navCM_datafusion.t, rad2deg(mov1.yaw_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
...
[mov2.navCM, mov2.kf] = arch4_imu2cm_filter_nomag(mov2.imu1, mov2.imu2, mov2.imu3, mov2.imu4);

[mov2.navCM_datafusion] = attitude_average_arch4(mov2.navCM);
arch4_mov2_navCM = mov2.navCM_datafusion;
save('arch4_mov2_navCM','arch4_mov2_navCM');
...
sgtitle('quaternions - KF. Movement 2. Architecture 4.','interpreter','latex')

subplot(4,1,1)
plot(mov2.navCM_datafusion.t, mov2.navCM_datafusion.qua(:,1), 'mo')
hold on
plot(mov2.navCM_datafusion.t, mov2.quat(:,1), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q1','interpreter','latex')
legend('q1 KF','q1 th','interpreter','latex')
...
subplot(4,1,2)
plot(mov2.navCM_datafusion.t, mov2.navCM_datafusion.qua(:,2), 'mo')
hold on
plot(mov2.navCM_datafusion.t, mov2.quat(:,2), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q2','interpreter','latex')
legend('q2 KF','q2 th','interpreter','latex')
...
subplot(4,1,3)
plot(mov2.navCM_datafusion.t, mov2.navCM_datafusion.qua(:,3), 'mo')
hold on
plot(mov2.navCM_datafusion.t, mov2.quat(:,3), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q3','interpreter','latex')
legend('q3 KF','q3 th','interpreter','latex')
...
subplot(4,1,4)
plot(mov2.navCM_datafusion.t, mov2.navCM_datafusion.qua(:,4), 'mo')
hold on
plot(mov2.navCM_datafusion.t, mov2.quat(:,4), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q4','interpreter','latex')
legend('q4 KF','q4 th','interpreter','latex')
...
fh = figure(4);
sgtitle('Euler angles - KF. Movement 2. Architecture 4.','interpreter','latex')

subplot(3,1,1)
plot(mov2.navCM_datafusion.t, mov2.navCM_datafusion.roll, 'mo')
hold on
plot(mov2.navCM_datafusion.t, rad2deg(mov2.roll_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('roll [deg]','interpreter','latex')
legend('roll KF','roll th','interpreter','latex')
...
subplot(3,1,2)
plot(mov2.navCM_datafusion.t, mov2.navCM_datafusion.pitch, 'mo')
hold on
plot(mov2.navCM_datafusion.t, rad2deg(mov2.pitch_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('pitch [deg]','interpreter','latex')
legend('pitch KF','pitch th','interpreter','latex')
...
subplot(3,1,3)
plot(mov2.navCM_datafusion.t, mov2.navCM_datafusion.yaw, 'mo')
hold on
plot(mov2.navCM_datafusion.t, rad2deg(mov2.yaw_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('yaw [deg]','interpreter','latex')
legend('yaw KF','yaw th','interpreter','latex')
...
[mov3.navCM, mov3.kf] = arch4_imu2cm_filter_nomag(mov3.imu1, mov3.imu2, mov3.imu3, mov3.imu4);

[mov3.navCM_datafusion] = attitude_average_arch4(mov3.navCM);
arch4_mov3_navCM = mov3.navCM_datafusion;
save('arch4_mov3_navCM','arch4_mov3_navCM');
...
sgtitle('quaternions - KF. Movement 3. Architecture 4.','interpreter','latex')

subplot(4,1,1)
plot(mov3.navCM_datafusion.t, mov3.navCM_datafusion.qua(:,1), 'mo')
hold on
plot(mov3.navCM_datafusion.t, mov3.quat(:,1), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q1','interpreter','latex')
legend('q1 KF','q1 th','interpreter','latex')
...
subplot(4,1,2)
plot(mov3.navCM_datafusion.t, mov3.navCM_datafusion.qua(:,2), 'mo')
hold on
plot(mov3.navCM_datafusion.t, mov3.quat(:,2), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q2','interpreter','latex')
legend('q2 KF','q2 th','interpreter','latex')
...
subplot(4,1,3)
plot(mov3.navCM_datafusion.t, mov3.navCM_datafusion.qua(:,3), 'mo')
hold on
plot(mov3.navCM_datafusion.t, mov3.quat(:,3), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q3','interpreter','latex')
legend('q3 KF','q3 th','interpreter','latex')
...
subplot(4,1,4)
plot(mov3.navCM_datafusion.t, mov3.navCM_datafusion.qua(:,4), 'mo')
hold on
plot(mov3.navCM_datafusion.t, mov3.quat(:,4), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q4','interpreter','latex')
legend('q4 KF','q4 th','interpreter','latex')
...
fh = figure(6);
sgtitle('Euler angles - KF. Movement 3. Architecture 4.','interpreter','latex')

subplot(3,1,1)
plot(mov3.navCM_datafusion.t, mov3.navCM_datafusion.roll, 'mo')
hold on
plot(mov3.navCM_datafusion.t, rad2deg(mov3.roll_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('roll [deg]','interpreter','latex')
legend('roll KF','roll th','interpreter','latex')
...
subplot(3,1,2)
plot(mov3.navCM_datafusion.t, mov3.navCM_datafusion.pitch, 'mo')
hold on
plot(mov3.navCM_datafusion.t, rad2deg(mov3.pitch_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('pitch [deg]','interpreter','latex')
legend('pitch KF','pitch th','interpreter','latex')
...
subplot(3,1,3)
plot(mov3.navCM_datafusion.t, mov3.navCM_datafusion.yaw, 'mo')
hold on
plot(mov3.navCM_datafusion.t, rad2deg(mov3.yaw_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('yaw [deg]','interpreter','latex')
legend('yaw KF','yaw th','interpreter','latex')
...
[mov4.navCM, mov4.kf] = arch4_imu2cm_filter_nomag(mov4.imu1, mov4.imu2, mov4.imu3, mov4.imu4);

[mov4.navCM_datafusion] = attitude_average_arch4(mov4.navCM);
arch4_mov4_navCM = mov4.navCM_datafusion;
save('arch4_mov4_navCM','arch4_mov4_navCM');
...
sgtitle('quaternions - KF. Movement 4. Architecture 4.','interpreter','latex')

subplot(4,1,1)
plot(mov4.navCM_datafusion.t, mov4.navCM_datafusion.qua(:,1), 'mo')
hold on
plot(mov4.navCM_datafusion.t, mov4.quat(:,1), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q1','interpreter','latex')
legend('q1 KF','q1 th','interpreter','latex')
...
subplot(4,1,2)
plot(mov4.navCM_datafusion.t, mov4.navCM_datafusion.qua(:,2), 'mo')
hold on
plot(mov4.navCM_datafusion.t, mov4.quat(:,2), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q2','interpreter','latex')
legend('q2 KF','q2 th','interpreter','latex')
...
subplot(4,1,3)
plot(mov4.navCM_datafusion.t, mov4.navCM_datafusion.qua(:,3), 'mo')
hold on
plot(mov4.navCM_datafusion.t, mov4.quat(:,3), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q3','interpreter','latex')
legend('q3 KF','q3 th','interpreter','latex')
...
subplot(4,1,4)
plot(mov4.navCM_datafusion.t, mov4.navCM_datafusion.qua(:,4), 'mo')
hold on
plot(mov4.navCM_datafusion.t, mov4.quat(:,4), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q4','interpreter','latex')
legend('q4 KF','q4 th','interpreter','latex')
...
fh = figure(8);
sgtitle('Euler angles - KF. Movement 4. Architecture 4.','interpreter','latex')

subplot(3,1,1)
plot(mov4.navCM_datafusion.t, mov4.navCM_datafusion.roll, 'mo')
hold on
plot(mov4.navCM_datafusion.t, rad2deg(mov4.roll_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('roll [deg]','interpreter','latex')
legend('roll KF','roll th','interpreter','latex')
...
subplot(3,1,2)
plot(mov4.navCM_datafusion.t, mov4.navCM_datafusion.pitch, 'mo')
hold on
plot(mov4.navCM_datafusion.t, rad2deg(mov4.pitch_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('pitch [deg]','interpreter','latex')
legend('pitch KF','pitch th','interpreter','latex')
...
subplot(3,1,3)
plot(mov4.navCM_datafusion.t, mov4.navCM_datafusion.yaw, 'mo')
hold on
plot(mov4.navCM_datafusion.t, rad2deg(mov4.yaw_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('yaw [deg]','interpreter','latex')
legend('yaw KF','yaw th','interpreter','latex')
...
[mov5.navCM, mov5.kf] = arch4_imu2cm_filter_nomag(mov5.imu1, mov5.imu2, mov5.imu3, mov5.imu4);

mov5.navCM.yaw1 = rad2deg(unwrap(deg2rad(mov5.navCM.yaw1)));
mov5.navCM.yaw2 = rad2deg(unwrap(deg2rad(mov5.navCM.yaw2)));
mov5.navCM.yaw3 = rad2deg(unwrap(deg2rad(mov5.navCM.yaw3)));
mov5.navCM.yaw4 = rad2deg(unwrap(deg2rad(mov5.navCM.yaw4)));

[mov5.navCM_datafusion] = attitude_average_arch4(mov5.navCM);
arch4_mov5_navCM = mov5.navCM_datafusion;
save('arch4_mov5_navCM','arch4_mov5_navCM');
...
sgtitle('quaternions - KF. Movement 5. Architecture 4.','interpreter','latex')

subplot(4,1,1)
plot(mov5.navCM_datafusion.t, mov5.navCM_datafusion.qua(:,1), 'mo')
hold on
plot(mov5.navCM_datafusion.t, mov5.quat(:,1), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q1','interpreter','latex')
legend('q1 KF','q1 th','interpreter','latex')
...
subplot(4,1,2)
plot(mov5.navCM_datafusion.t, mov5.navCM_datafusion.qua(:,2), 'mo')
hold on
plot(mov5.navCM_datafusion.t, mov5.quat(:,2), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q2','interpreter','latex')
legend('q2 KF','q2 th','interpreter','latex')
...
subplot(4,1,3)
plot(mov5.navCM_datafusion.t, mov5.navCM_datafusion.qua(:,3), 'mo')
hold on
plot(mov5.navCM_datafusion.t, mov5.quat(:,3), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q3','interpreter','latex')
legend('q3 KF','q3 th','interpreter','latex')
...
subplot(4,1,4)
plot(mov5.navCM_datafusion.t, mov5.navCM_datafusion.qua(:,4), 'mo')
hold on
plot(mov5.navCM_datafusion.t, mov5.quat(:,4), 'k','LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('q4','interpreter','latex')
legend('q4 KF','q4 th','interpreter','latex')
...
fh = figure(10);
% fh.WindowState = 'maximized';
sgtitle('Euler angles - KF. Movement 5. Architecture 4.','interpreter','latex')

subplot(3,1,1)
plot(mov5.navCM_datafusion.t, mov5.navCM_datafusion.roll, 'mo')
hold on
plot(mov5.navCM_datafusion.t, rad2deg(mov5.roll_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('roll [deg]','interpreter','latex')
legend('roll KF','roll th','interpreter','latex')
...
subplot(3,1,2)
plot(mov5.navCM_datafusion.t, mov5.navCM_datafusion.pitch, 'mo')
hold on
plot(mov5.navCM_datafusion.t, rad2deg(mov5.pitch_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('pitch [deg]','interpreter','latex')
legend('pitch KF','pitch th','interpreter','latex')
...
subplot(3,1,3)
plot(mov5.navCM_datafusion.t, mov5.navCM_datafusion.yaw, 'mo')
hold on
plot(mov5.navCM_datafusion.t, rad2deg(mov5.yaw_true),'k', 'LineWidth',2)
hold off
xlabel('Time [s]','interpreter','latex')
ylabel('yaw [deg]','interpreter','latex')
legend('yaw KF','yaw th','interpreter','latex')
