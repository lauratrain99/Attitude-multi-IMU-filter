function [nav , kf] = imu_filter_nomag(imu)
%
% imu_filter filters 6 DOF IMU measurements by using an Extended Kalman filter.
% It only uses gyroscope and accelerometer
%
% INPUT
