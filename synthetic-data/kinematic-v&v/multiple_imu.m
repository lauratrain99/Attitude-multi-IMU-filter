...
figure(1)
plot(imuMAIN.t, imuMAIN.wv(:,1), 'b', imu1MAINcomputed.t, ... 
     imu1MAINcomputed.wv(:,1), '*b', imuMAIN.t, imuMAIN.wv(:,2), ...
     'r', imu1MAINcomputed.t, imu1MAINcomputed.wv(:,2), '*r', ...
     imuMAIN.t, imuMAIN.wv(:,3), 'g', imu1MAINcomputed.t, ...
     imu1MAINcomputed.wv(:,3), '*g')
xlabel('Time [s]')
