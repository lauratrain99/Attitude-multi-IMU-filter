...
[nav1, imuCM1] = arch2_imu2cm_filter_nomag(imu1);
[nav2, imuCM2] = arch2_imu2cm_filter_nomag(imu2);
[nav3, imuCM3] = arch2_imu2cm_filter_nomag(imu3);
[nav4, imuCM4] = arch2_imu2cm_filter_nomag(imu4);

% Fusion of the four measurements
[navCM] = attitude_average_arch2(nav1, nav2, nav3, nav4);
...
sgtitle('Quaternions. Architecture 2.','interpreter','latex')

subplot(4,1,1)
plot(navCM.t, navCM.qua(:,1), 'oc')
hold on
...
fh = figure(2);
% fh.WindowState = 'maximized';
sgtitle('Euler angles.  Architecture 2.','interpreter','latex')

subplot(3,1,1)
plot(navCM.t, navCM.roll, 'oc')
hold on
